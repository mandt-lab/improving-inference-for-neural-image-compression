...
Implement iterative inference with Deterministic Annealing (A4 in Table 1 of paper), in
    ...
    with tf.Session() as sess:
        ...
        def annealed_temperature(t, r, ub, lb=1e-8, backend=np):
            ...
            if backend is None:
                ...
                return backend.minimum(backend.maximum(backend.exp(-r * t), lb), ub)
        ...
        while True:
            try:
                ...
                for it in range(rd_opt_its):
                    temperature = annealed_temperature(it, r=annealing_rate, ub=T_ub)
